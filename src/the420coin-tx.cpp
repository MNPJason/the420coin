...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("The420Coin Core the420coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  the420coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded the420coin transaction") + "\n" +
              "  the420coin-tx [options] -create [commands]   " + _("Create hex-encoded the420coin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded the420coin transaction
