...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "The420CoinNetwork") type = The420CoinNetwork;
    if(strType == "The420CoinNetworkVariable") type = The420CoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == The420CoinNetwork) s = "The420CoinNetwork";
    if(type == The420CoinNetworkVariable) s = "The420CoinNetworkVariable";
