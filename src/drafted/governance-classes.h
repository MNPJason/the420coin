 ...
 *
 *   // network
 *   CThe420CoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CThe420CoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CThe420CoinNetwork(UniValue objIn)
    {
...
// // can be under: The420CoinNetwork
// //   -- signature requirements : Key1(User)
// class CThe420CoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == The420CoinNetwork);
//     // }
