...
2. run the420coind with -printalert or -sendalert like this:
   /path/to/the420coind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.the420coincrypto.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/The420Coin Core:0.12.0.58/"));
