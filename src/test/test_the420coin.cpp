...
#define BOOST_TEST_MODULE The420Coin Test Suite

#include "test_the420coin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_the420coin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
