...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("The420Coin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  the420coin-cli [options] <command> [params]  " + _("Send command to The420Coin Core") + "\n" +
                  "  the420coin-cli [options] help                " + _("List commands") + "\n" +
                  "  the420coin-cli [options] help <command>      " + _("Get help for a command") + "\n";
