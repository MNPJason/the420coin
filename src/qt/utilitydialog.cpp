    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("The420Coin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About The420Coin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  the420coin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the The420Coin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FRTWY, 0.1 FRTWY, 1 FRTWY and 10 FRTWY -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("The420Coin Core is shutting down...") + "<br /><br />" +
