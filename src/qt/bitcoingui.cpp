    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("The420Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a The420Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and the420coin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About The420Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about The420Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for The420Coin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your The420Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified The420Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a the420coin: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/information"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the The420Coin Core help message to get a list with possible The420Coin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("The420Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to The420Coin network", "", count));
    } else {
...
{
    QString strTitle = tr("The420Coin Core"); // default title
    ...
    // Append title to "The420Coin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
