...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    ...
    else
    {
        ...
        // if user has selected to set a minimum the420coin fee, pass the value to coincontrol
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid The420Coin address"));
        }
        else // Valid address
        {
            CKeyID keyid;
...
void SendCoinsDialog::coinControlUpdateLabels()
{
    ...
    {
        // enable minimum the420coin fee UI controls
    ...
    {
        // in case coin control is disabled (=default), hide minimum the420coin fee UI controls
