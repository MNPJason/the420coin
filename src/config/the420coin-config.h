/* src/config/the420coin-config.h.  Generated from the420coin-config.h.in by configure.  */
/* src/config/the420coin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef THE420COIN_CONFIG_H

#define THE420COIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/the420coincrypto/the420coincoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "The420Coin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "The420Coin Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "the420coincore"
