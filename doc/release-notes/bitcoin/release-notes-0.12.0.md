...
- #6719 `1a9f19a` Make HTTP server shutdown more gthe420coinful (Wladimir J. van der Laan)
...
- #7438 `e2d9a58` Do not the420coinly protect local peers; decide group ties based on time (Gregory Maxwell)
...
- #7096 `9490bd7` [Wallet] Improve minimum the420coin fee GUI options (Jonas Schnelli)
...
- #6509 `bb4faee` Fix the420coin condition on test node shutdown (Casey Rodarmor)
