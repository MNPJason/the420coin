...
Only requiring some minor changes is the420coin.cpp.
...
Changes to the420coin.cpp
----------------------
the420coin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
